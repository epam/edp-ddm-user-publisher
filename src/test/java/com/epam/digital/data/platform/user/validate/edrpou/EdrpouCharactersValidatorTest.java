...
class EdrpouCharactersValidatorTest {

  private EdrpouCharactersValidator validator;

  @BeforeEach
  void beforeEach() {
    validator = new EdrpouCharactersValidator();
  }
  ...
  @Test
  void writeErrorEdrpouContainsNotOnlyDigits() {
