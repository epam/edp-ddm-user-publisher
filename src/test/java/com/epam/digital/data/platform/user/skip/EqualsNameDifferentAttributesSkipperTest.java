...
class EqualsNameDifferentAttributesSkipperTest {

  private EqualsNameDifferentAttributesSkipper skipper;
  private ExistingUsersProvider existingUsersProvider;

  @BeforeEach
  void beforeEach() {
    existingUsersProvider = mock(ExistingUsersProvider.class);
    skipper = new EqualsNameDifferentAttributesSkipper(existingUsersProvider);
  }

  @Test
  void shouldSkipUserIfExistUserWithTheSameNameButWithDifferentAttributes() {
