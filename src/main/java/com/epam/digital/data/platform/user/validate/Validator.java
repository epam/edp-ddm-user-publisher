...
public abstract class Validator {
  ...
  public abstract ValidationResult validate(
      int userSequenceNumber, CsvUser user, ValidationResult results);

  protected ValidationResult validateNext(
      int userSequenceNumber, CsvUser user, ValidationResult results) {
    if (nextValidator == null) {
      return results;
    }
    return nextValidator.validate(userSequenceNumber, user, results);
  }
}
